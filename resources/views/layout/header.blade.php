...
<!-- Theme style -->
<link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/css/adminlte.min.css">
<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
      page. However, you can choose any other skin. Make sure you
      apply the skin class to the body tag so the changes take effect. -->
<link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/css/skinblue.min.css">
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Alexa Kunnummyalil</span>
            </a>
            <ul class="dropdown-menu">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>@yield('heading')<small>@yield('subheading')</small></h1>
    </section>
